      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('ticket.update',$lists->id) }}" enctype="multipart/form-data">
              @csrf
              {{ method_field('PUT') }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <img src="{{ asset('user/img/tickets/'.$lists->image) }}" width="100px" height="100px">
